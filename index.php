...
<body>
    ...
    <main>
        <div id="section1">
            ...
            <p>
                At The Book Shelf, we're passionate about literature, curating a diverse collection with care and
                integrity. Our customer-centric approach ensures satisfaction through transparent, fair interactions. We
                actively engage with our community, innovate continuously, and promote sustainability in all our
                practices.
            </p>
        </div>
        <div id="section-2">
            ...
            <a href="products.php"><button type="button"> See More </button></a>
        </div>
    </main>
