    ...
    <div class="admin">
        <div class="admin-card">
            <div class="admin-card-content">
                ...
                <form class="adminform" action="<?php echo $_SERVER['PHP_SELF']?>" method="POST" id="admin_form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="book_name" id="book_name" class="form-input" placeholder="Enter Book Name">
                    </div>
                    <div class="form-group">
                        <label for="book_description" class="form-label">Book Description</label>
                        <textarea name="book_description" id="book_description" class="form-input" placeholder="Enter Book Description"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="book_author" class="form-label">Book Author</label>
                        <input type="text" name="book_author" id="book_author" class="form-input" placeholder="Enter Book Author">
                    </div>
                    <div class="form-group">
                        <label for="book_price" class="form-label">Book Price</label>
                        <input type="text" name="book_price" id="book_price" class="form-input" placeholder="Enter Book Price">
                    </div>
                    <div class="form-group">
